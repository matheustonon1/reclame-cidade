  ...
  return (
    <div ref={containerRef} className="relative">
      <button
        ...
        className="relative rounded-lg p-2 text-slate-600 hover:bg-slate-50 hover:text-slate-900"
      >
      ...
      {aberto && (
        <div className="absolute right-0 z-10 mt-1 w-80 rounded-lg border border-slate-200 bg-white py-1 shadow-md">
